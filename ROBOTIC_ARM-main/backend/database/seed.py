...
def seed_robots():
    ...
    manufacturers = ["ABB", "KUKA", "Fanuc", "Yaskawa", "Universal Robots", "Siemens"]
    ...
    for i in range(ROBOT_COUNT):
        ...
        robot = RobotArm(
            ...
            payload_capacity=round(random.uniform(5, 50), 2),
            reach=round(random.uniform(1, 4), 2),
...
def seed_sensors():
    ...
    sensor_types = ["Temperature", "Vibration", "Current", "Voltage", "Humidity"]

    manufacturers = ["Bosch", "Honeywell", "Siemens", "ABB", "Omron"]
...
def seed_telemetry():
    ...
    print(f"{len(telemetry_records)} real ML telemetry records inserted")
...
def seed_predictions():
    ...
    for _ in range(PREDICTION_COUNT):
        ...
        prediction = Prediction(
            robot_id=random.choice(robots).robot_id,
            failure_probability=round(random.uniform(0.01, 0.99), 2),
            predicted_fault=random.choice(faults),
            confidence=round(random.uniform(0.70, 0.99), 2),
            recommendation=random.choice(recommendations),
            prediction_time=fake.date_time_between(start_date="-30d", end_date="now"),
        )
...
def seed_maintenance():
    ...
    for _ in range(MAINTENANCE_COUNT):
        ...
        maintenance = Maintenance(
            ...
            maintenance_date=fake.date_between(start_date="-180d", end_date="today"),
            next_due_date=fake.date_between(start_date="today", end_date="+180d"),
...
def seed_incidents():
    ...
    for _ in range(INCIDENT_COUNT):
        ...
        incident = Incident(
            ...
            incident_time=fake.date_time_between(start_date="-90d", end_date="now"),
        )
