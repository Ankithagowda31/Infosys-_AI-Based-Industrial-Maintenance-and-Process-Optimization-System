...
@router.post(
    ...
    responses={
        201: {"description": "Telemetry created successfully"},
...
@router.get(
    ...
    responses={200: {"description": "Telemetry records retrieved successfully"}},
)
...
@router.get(
    ...
    responses={
        ...
        404: {"description": "Telemetry not found for this robot"},
    },
)
def fetch_latest_robot_telemetry(robot_id: int, db: Session = Depends(get_db)):
...
@router.get(
    ...
    responses={
        200: {"description": "Telemetry retrieved successfully"},
        404: {"description": "Telemetry not found"},
    },
)
def fetch_telemetry(telemetry_id: int, db: Session = Depends(get_db)):
...
@router.put(
    ...
    responses={
        200: {"description": "Telemetry updated successfully"},
        400: {"description": "Invalid request data"},
        404: {"description": "Telemetry not found"},
    },
)
def edit_telemetry(
    telemetry_id: int, telemetry: TelemetryUpdate, db: Session = Depends(get_db)
):
...
def remove_telemetry(telemetry_id: int, db: Session = Depends(get_db)):
