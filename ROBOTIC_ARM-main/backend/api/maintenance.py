...
@router.post(
    ...
    responses={
        201: {"description": "Maintenance record created successfully"},
...
@router.get(
    ...
    responses={200: {"description": "Maintenance records retrieved successfully"}},
)
...
@router.get(
    ...
    responses={
        200: {"description": "Maintenance record retrieved successfully"},
...
@router.put(
    ...
    responses={
        200: {"description": "Maintenance record updated successfully"},
        400: {"description": "Invalid request data"},
        404: {"description": "Maintenance record not found"},
    },
)
